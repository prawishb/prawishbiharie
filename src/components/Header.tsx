...
const Header = () => {
  ...
  return (
    <motion.header
      ...
      className="bg-transparent backdrop-blur-md text-slate-100 fixed top-0 inset-x-0 z-[9999]"
    >
      <nav className="">
        <div className="max-w-5xl mx-auto p-4 h-20 w-full flex items-center justify-between">
          {/* Logo */}
